...
// WiFi credentials.
const char *WIFI_SSID = "HUAWEI P smart 2019"; //"Freebox-419FDB";                        //"stanmeurthe-eqt";
const char *WIFI_PASS = "61547849cad7"; //"claudendo76-admirand-colosus6-mirati3"; //"DNSU54StanMeurthe54";

const String apiURL = "http://nodered.lf2l.fr/api/smartcollector/";
const String MCUid = "ESP8266-2";
//const char *token = "Basic dXNlcjpTdXBlclBhc3N3b3Jk";
const char *APIuser = "user";
const char *APIpass = "SuperPassword";
